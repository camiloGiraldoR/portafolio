export const portfolioData = {
    es: {
        ...
        skills: [
            ...
            { category: "Fundamentos de IA", items: ["LLM Teórico", "RAG Teórico", "Prompt Engineering"] },
            { category: "IA & Herramientas", items: ["AI Augmented", "GitHub Copilot", "Gemini", "Bedrock", "Portkey"] },
    ...
    en: {
        ...
        skills: [
            ...
            { category: "Databases", items: ["PostgreSQL", "Oracle DB", "MySQL", "SQL Server", "Redis", "MongoDB", "Azure DB2"] },
            { category: "Cloud & DevOps", items: ["AWS (RDS, IAM, S3, EC2)", "Azure", "CI/CD", "Jenkins", "Anthos", "Kubernetes", "Docker"] },
            { category: "AI Fundamentals", items: ["Theoretical LLM", "Theoretical RAG", "Prompt Engineering"] },
            { category: "AI & Augmented Tools", items: ["AI Augmented", "GitHub Copilot", "Gemini", "Bedrock", "Portkey"] },
            { category: "Tools & Testing", items: ["JUnit 5", "Mockito", "Maven", "Gradle", "Git", "Jest", "Kafka", "NewRelic", "Scrum"] },
        ],
        experience: [
            {
